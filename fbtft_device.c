...
#ifdef CONFIG_FB_TFT_SSD1289
static int write_gpio16_wr_slow(struct fbtft_par *par, void *buf, size_t len);
#endif
#ifdef CONFIG_FB_TFT_ST7735R
...
#ifdef CONFIG_FB_TFT_AGM1264K_FL
	{
		.name = "agm1264k-fl",
